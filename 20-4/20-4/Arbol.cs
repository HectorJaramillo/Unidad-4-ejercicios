...
namespace _20_4
{
    public class Arbol //Clase arbol
    {
        ...
        {
            List<String> Frutitas = new List<String>();
            Frutitas.Add("Banana");
            ...
            if (recorrido != null)
            {
                ...
                Console.Write(Frutitas[recorrido.info] + " ");
        ...
        private void ImprimirEntre(Nodo recorrido) //Metodo recursivo que imprime los datos en InOrden
        {
            ...
            Frutitas.Add("Mango");
            Frutitas.Add("Papaya");
            Frutitas = Frutitas.OrderBy(o => o).ToList();//Ordena los elementos de la lista por orden alfabetico
            if (recorrido != null)
            {
                ImprimirEntre(recorrido.izq);
                Console.Write(Frutitas[recorrido.info] + " ");//Imprime la el  contenido de la posicion de la lista
